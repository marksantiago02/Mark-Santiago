...
export default function MetaData({
  ...
  return (
    <Head>
      ...
      <title>{title + (suffix ? ` - ${suffix}` : '') + ' | marksantiago0929'}</title>
      ...
      <meta
        ...
        content={`${
          keywords || ''
        }, Mark, Mark Santiago, marksantiago, santiago, marksantiago0929, mark blog, mark portfolio, web development, blockchain development, Mark Santiago portfolio`}
      />
      {/* Og */}
      <meta property="og:title" content={`${title}${suffix ? ` - ${suffix}` : ''} | mark0929`} />
